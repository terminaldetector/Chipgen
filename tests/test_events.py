...
def test_every_type_round_trips_through_dict():
    samples = {
        ...
        "Portamento": E.Portamento(target="fm0", cents_per_second=-600.0,
                                   to_cents=-200.0),
        "Vibrato": E.Vibrato(target="psg1", depth_cents=75.0, speed_hz=6.5,
                             delay=0.12),
        ...
        "OPLNoteOff": E.OPLNoteOff(channel=8),
        "OPLVolume": E.OPLVolume(channel=5, volume=88),
        "OPLDepth": E.OPLDepth(tremolo=1, vibrato=0),
        "OPLOperator": E.OPLOperator(channel=3, operator=2, field="wave",
                                     value=2),
